  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: 6, marginBottom: 14 }}>
        ...
        <button style={btnStyle(mode === "topic")} onClick={() => setMode("topic")}>
          Topic
        </button>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
        ...
        {mode === "topic" && (
          <input
            type="text"
            placeholder="e.g. mitosis, Kant's categorical imperative…"
            value={topic}
